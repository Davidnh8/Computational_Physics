...
#define __PYX_HAVE__two_object
#define __PYX_HAVE_API__two_object
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'two_object' */
#define __Pyx_MODULE_NAME "two_object"
int __pyx_module_is_main_two_object = 0;

/* Implementation of 'two_object' */
...
static PyObject *__pyx_f_10two_object_two_object(void) {
  double __pyx_v_dt;
  double __pyx_v_a;
  double __pyx_v_dv;
  double __pyx_v_ds;
 ...
 */
  ...
  __Pyx_AddTraceback("two_object.two_object", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittwo_object(void); /*proto*/
PyMODINIT_FUNC inittwo_object(void)
#else
PyMODINIT_FUNC PyInit_two_object(void); /*proto*/
PyMODINIT_FUNC PyInit_two_object(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_two_object(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("two_object", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_two_object) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "two_object")) {
      if (unlikely(PyDict_SetItemString(modules, "two_object", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init two_object", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init two_object");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
